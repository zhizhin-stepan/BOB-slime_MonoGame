...
- Игрок/Игра:
  ...
  Управление: Движение - WASD\(стрелки), прыжок - Space, смена цвета - ЛКМ\E, экипировка предмета - (1, 2, 3).
  Интерфейс: 
...
- Игра/Игра:
  ...
  Другие объекты реагируют на взаимодействие со слаймом так: если это объект категории Предмет, то слайм может "войти" в этот объект, он исчезнет с локации, а у слайма в меню 
